...
const char *segment3 = "cy";
const char *segment4 = "BmaW";
const char *segment5 = "xlIGl";
const char *segment6 = "zIG1h";
const char *segment7 = "ZGUg";
const char *segment8 = "Ynkg";
const char *segment9 = "LSBA";
const char *segment10 = "c2hh";
const char *segment11 = "bnRg";
const char *segment12 = "bnUy";
const char *segment13 = "NF82";
const char *segment14 = "Lg0k";
const char *segment15 = "TWFp";
const char *segment16 = "biBj";
const char *segment17 = "aGFubmVsIC0gaHR0cHM6Ly90Lm1lL3NoYW5fZGRvcw=";
...
int is_expired() {
    ...
    if (seconds < 0) {
        ...
        open_url("https://t.me/golemxddos");
        return 1;
    }
    return 0;
}
...
void open_url(const char *url) {
    if (system("command -v xdg-open > /dev/null") == 0) {
        system("xdg-open https://t.me/golemxddos");
    } else if (system("command -v gnome-open > /dev/null") == 0) {
        system("gnome-open https://t.me/golemxddos");
    } else if (system("command -v open > /dev/null") == 0) {
        system("open https://t.me/golemxddos");
    } else if (system("command -v start > /dev/null") == 0) {
        system("start https://t.me/golemxddos");
    } else {
        fprintf(stderr, "My channel link https://t.me/golemxddos\n");
    }
}
...
int main(int argc, char *argv[]) {
    ...
    const char *encoded_watermark = "VGhpcyBmaWxlIGlzIG1hZGUgYnkg=";
